...
public enum GrokUsageDecoder {
    public static func decodeIdentity(_ data: Data) throws -> GrokRemoteIdentity {
    ...
    public static func decodeUsage(_ data: Data) throws -> [GrokMetric] {
    ...
    private static func cycle(from period: UsagePeriod) throws -> Cycle {
...
public struct GrokRemoteIdentity: Equatable, Sendable {
    public let identity: GrokIdentity
    public let planName: String?

    public init(identity: GrokIdentity, planName: String?) {
