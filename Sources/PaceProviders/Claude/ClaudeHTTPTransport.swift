...
struct ClaudeHTTPResponse: Sendable {
    let statusCode: Int
...
struct ClaudeURLSessionTransport: ClaudeHTTPTransport {
    ...
    init() {
        ...
        session = URLSession(
            ...
            delegate: ClaudeRedirectBlocker(),
            delegateQueue: nil,
        )
    }
...
private final class ClaudeRedirectBlocker: NSObject, URLSessionTaskDelegate {
    func urlSession(
        _: URLSession,
